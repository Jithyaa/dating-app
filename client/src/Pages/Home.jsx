  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <Link
            to="/user/signup"
            className="text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Create account
          </Link>
      </div>
